"""
Plot a global visibility map for a celestial object
...
class Map():
    ...
    def __init__(self, lon1=-170., lon2=190.,
        ...
        lon1/lon2: Longitudes of the left/right edges of the map (degrees east)
        lat1/lat2: Latitudes of the bottom/top edges of the map (degrees north)
        """
    ...
    def set_target(self, ra, dec):
        """Define the target by giving fixed ra/dec coordinates"""
    ...
    def set_target_xephem(self, xephem):
        """Define the target using an xephem ephemeris line"""
    ...
    def render(self, date, mode='web'):
        ...
        cb = self.figure.colorbar(im, orientation='horizontal',
                                  pad=0.02, shrink=0.95,
                                  ticks=[0, 30, 60, 90], aspect=50,
